            ...
            <div class="chat-shell chat-shine relative z-10 overflow-hidden rounded-[2rem] border border-white/10 bg-white/[.06] shadow-2xl backdrop-blur-2xl">
                ...
                <div class="chat-scroll max-h-[560px] min-h-[430px] overflow-y-auto px-5 py-6 space-y-5 flex flex-col">
                                    ...
                                    @if($isMine)
                                        <div class="flex flex-col gap-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300">
                                            ...
                                            <form method="POST"
                                                ...
                                                <button class="flex h-9 w-9 items-center justify-center rounded-xl border border-red-400/20 bg-red-500/10 text-red-300 shadow-lg transition hover:scale-110 hover:bg-red-500/20"
                                                        title="Delete">
                    ...
                    @endforelse
                                ...
                                {{-- Message Composer --}}
                <div class="border-t border-white/10 bg-slate-950/55 p-4">
                    <form method="POST"
                        ...
                        <textarea name="body"
                                  ...
                                  class="chat-input min-h-[95px] resize-none"></textarea>

                        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                            <label class="group flex cursor-pointer items-center gap-3 rounded-2xl border border-dashed border-white/15 bg-white/10 px-5 py-3 text-sm font-black text-slate-200 transition hover:border-cyan-400/60 hover:bg-cyan-400/10">
                                <span class="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-500 to-fuchsia-500 text-white shadow-lg transition group-hover:scale-110">
                                    <i class="fas fa-paperclip"></i>
                                </span>

                                <span>
                                    Attach File / Image / Audio / Video
                                </span>
                            ...
                            <button type="submit"
                                    class="inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-cyan-500 via-indigo-600 to-fuchsia-600 px-8 py-4 text-sm font-black text-white shadow-xl shadow-cyan-500/20 transition hover:scale-105">
                        ...
                        <p class="text-xs font-semibold text-slate-500">
                            Supported: image, PDF, DOC, ZIP, TXT, MP3, MP4.
                        </p>
                    </form>
                </div>
            </div>
