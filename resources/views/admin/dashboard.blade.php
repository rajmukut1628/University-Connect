    ...
    <x-slot name="header">
        <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-slate-950 via-indigo-950 to-purple-950 p-8 shadow-2xl border border-white/10">
            ...
            <div class="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div>
                    <p class="text-sm uppercase tracking-[0.35em] text-cyan-300 font-bold">University Connect AI Core</p>
                ...
                <div class="uc-card p-6">
                    <div class="relative z-10">
                        ...
                        <div class="mt-5 h-2 rounded-full bg-white/20 overflow-hidden">
                            <div class="h-full rounded-full bg-gradient-to-r {{ $card['from'] }} {{ $card['to'] }}" style="width: {{ min(100, 25 + ($index * 9)) }}%"></div>
                        </div>
                    </div>
                </div>
            @endforeach
            ...
            <div class="xl:col-span-2 space-y-8">
                ...
                <div class="uc-card p-7">
                    <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-7">
                        <div>
                            <p class="text-sm uppercase tracking-[0.25em] text-indigo-500 font-black">AI Overview</p>
                            <h3 class="text-2xl font-black text-slate-900 dark:text-white mt-1">University Activity Pulse</h3>
                        </div>

                        <button class="px-5 py-3 rounded-2xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-bold shadow-xl hover:scale-105 transition">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center justify-between mb-5">
                                ...
                                <span class="text-xs px-3 py-1 rounded-full bg-cyan-500/20 text-cyan-300 font-bold">DATABASE POWERED</span>
                            </div>
                ...
                <div class="uc-card p-7">
                    <div class="relative z-10 flex items-center justify-between mb-6">
                        ...
                        <span class="px-4 py-2 rounded-xl bg-purple-500/15 text-purple-600 font-bold">
                            {{ $recentUsers->count() }} Latest
                        </span>
                    </div>
                ...
                <div class="uc-card p-7">
                    <div class="relative z-10 flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('jobs.index') }}" class="px-4 py-2 rounded-xl bg-pink-500/15 text-pink-600 font-bold hover:bg-pink-500/25 transition">
                            View Jobs
                        </a>
                    </div>
                ...
                <div class="uc-card p-7">
                    <div class="relative z-10">
                        ...
                        <h3 class="text-2xl font-black text-slate-900 dark:text-white mt-1 mb-6">Admin Tools</h3>
   ...
   class="block w-full group rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-600 p-[1px]">
    <div class="rounded-2xl bg-slate-950 px-5 py-4 text-white font-bold flex items-center justify-between group-hover:bg-transparent transition-all duration-300">
        ...
        <i class="fas fa-arrow-right group-hover:translate-x-1 transition-transform"></i>
                            ...
                            <a href="{{ route('jobs.index') }}" class="block w-full group rounded-2xl bg-gradient-to-r from-indigo-600 to-cyan-500 p-[1px]">
                            ...
                            <a href="{{ route('events.index') }}" class="block w-full group rounded-2xl bg-gradient-to-r from-emerald-500 to-lime-500 p-[1px]">
                                <div class="rounded-2xl bg-slate-950 px-5 py-4 text-white font-bold flex items-center justify-between group-hover:bg-transparent transition">
                            ...
                            <a href="{{ route('notifications.index') }}" class="block w-full group rounded-2xl bg-gradient-to-r from-fuchsia-600 to-pink-500 p-[1px]">
                                <div class="rounded-2xl bg-slate-950 px-5 py-4 text-white font-bold flex items-center justify-between group-hover:bg-transparent transition">
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="font-black text-slate-900 dark:text-white">
                                                {{ $mentorship->student_name }} → {{ $mentorship->mentor_name }}
                                            </p>
