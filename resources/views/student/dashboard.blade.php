        ...
        <div class="grid
            ...
            <div class="xl:col-span-2
                ...
                <div class="relative z-10 p-6 md:p-8">
                    ...
                    <div class="flex
                        ...
                        <div>
                            ...
                            <p class="mt-2
                                ...
                                Ask about study planning, CV preparation,
                                internships, programming skills, career
                    ...
                    <form
                        method="POST"
                        action="{{ route('student.ai-assistant') }}"
                        class="mt-7"
                    >
