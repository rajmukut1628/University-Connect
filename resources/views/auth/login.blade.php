        ...
        <div class="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div class="hidden lg:block">
                ...
                <p class="mt-5 text-slate-300 text-lg max-w-xl">
                    Access your AI-powered campus dashboard, mentorship network, job portal, events and smart university ecosystem.
                </p>
            </div>
            ...
            <div class="rounded-[2rem] border border-white/10 bg-white/10 backdrop-blur-2xl shadow-2xl p-7 md:p-9">
                <div class="text-center mb-8">
                    ...
                    <p class="mt-2 text-sm text-slate-300">Enter your verified account credentials</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        <label class="text-sm font-bold text-slate-200">Email Address</label>
                    ...
                    <div class="flex items-center justify-between text-sm">
                        <label class="inline-flex items-center gap-2 text-slate-300">
                            <input type="checkbox" name="remember" class="rounded border-white/20 bg-white/10 text-cyan-500 focus:ring-cyan-400">
                            Remember me
                        </label>

                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-cyan-300 font-bold hover:text-white">
                                Forgot?
                            </a>
                        @endif
                    </div>

                    <button class="w-full rounded-2xl bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500 py-3.5 font-black shadow-2xl shadow-cyan-500/30 hover:scale-[1.02] transition">
                    ...
                    <p class="text-center text-sm text-slate-300">
                        New here?
                        <a href="{{ route('register') }}" class="text-cyan-300 font-black hover:text-white">Create account</a>
                    </p>
                </form>
            </div>
        </div>
